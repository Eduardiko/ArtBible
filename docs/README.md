...
Here's a display of a sample template I created for Project II. If it is not shown, download it by clicking [here](https://github.com/WillyTrek19/ArtBible/blob/main/templates/ArtBible.pdf?raw=true) a

<embed src="https://willytrek19.github.io/ArtBible/templates/ArtBible.pdf" class="application/pdf" width = "100%" height="850px" />
